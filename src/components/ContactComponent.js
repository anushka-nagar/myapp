...
class Contact extends Component {
    ...
    handleSubmit(values){
        ...
        alert("Your form info is " + JSON.stringify(values));
                        ...
                        <Form model="feedback" onSubmit={(values) => this.handleSubmit(values)}>
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    ...
                                    messages={{
                                        required: "Required. ",
                                        minlength: "Greater than 2 chars. ",
                                        maxlength: "Less than 15 chars. "
                                    }}></Errors>
                                </Col>
                            </Row>
                            <Row className="form-group">
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    ...
                                    validators={{required, minlength : minlength(3), maxlength : maxlength(15), isnum}}></Control.text>
                                    <Errors 
                                    className="text-danger"
                                    model = ".telnum"
                                    show="touched"
                                    messages={{
                                        required: "Required. ",
                                        minlength: "Greater than 2 numbers. ",
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text model=".email" id="email" name="email" placeholder="email@mail.com" className="form-control"
