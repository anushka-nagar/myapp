...
class Contact extends Component {
    ...
    handleSubmit(event){
        ...
        alert("Your form info is " + JSON.stringify(this.state))
                    ...
                    <div className="col-12 col-md-9">
                        <Form onSubmit={this.handleSubmit}>
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type="email" id="email" name="email" placeholder="email@mail.com" value={this.state.email} valid={errors.email === ''} invalid={errors.email !== ''}
